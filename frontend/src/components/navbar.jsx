...
function Navbar({ contactRef, aboutRef, productsRef, background, Navbar }) {
    ...
    return (
        <div className={`container-fluid fixed-top container-navbar ${lastScrollTop > 0.3 * window.innerHeight || background === 'light' ? 'bg-white' : ''}`} style={{ width: '100%', minHeight: "4.5rem", height: '13%', maxHeight: "5.2rem", filter: navFilter, transition: '1s' }}>
